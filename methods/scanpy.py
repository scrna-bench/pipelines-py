...
def run_scanpy(
    ...
    end_time = time()
    starts_ends["find_mit_gene"] = (start_time, end_time)
    ...
    end_time = time()
    starts_ends["filter"] = (start_time, end_time)
    ...
    sc.pp.log1p(adata)
    end_time = time()
    starts_ends["normalization"] = (start_time, end_time)
    time_elapsed = end_time - start_time
    print("Time Elapsed:", time_elapsed)
    ...
    end_time = time()
    starts_ends["hvg"] = (start_time, end_time)
    ...
    sc.tl.tsne(adata)
    end_time = time()
    starts_ends["t_sne"] = (start_time, end_time)
    time_elapsed = end_time - start_time
    print("Time Elapsed:", time_elapsed)
    ...
    sc.tl.umap(adata)
    end_time = time()
    starts_ends["umap"] = (start_time, end_time)
    time_elapsed = end_time - start_time
    print("Time Elapsed:", time_elapsed)
    ...
    end_time = time()
    starts_ends["louvain"] = (start_time, end_time)
    time_elapsed = end_time - start_time
    ...
    end_time = time()
    starts_ends["leiden"] = (start_time, end_time)
    time_elapsed = end_time - start_time
    avg_time_elapsed = time_elapsed / num_runs
